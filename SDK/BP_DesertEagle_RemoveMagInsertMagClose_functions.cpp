...
bool UBP_DesertEagle_RemoveMagInsertMagClose_C::CanExecuteUsingData(struct FWeaponReloadData* Data)
{
	...
	UBP_DesertEagle_RemoveMagInsertMagClose_C_CanExecuteUsingData_Params params;
	params.Data = Data;
