...
public:
	...
	int                                                FontSize;                                                 // 0x0260(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FMargin                                     TextPadding;                                              // 0x0264(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   SizeOverride;                                             // 0x0274(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	TEnumAsByte<EHorizontalAlignment>                  TextHorizontalAlignment;                                  // 0x027C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x027D(0x0003) MISSED OFFSET
	struct FLinearColor                                TextColour;                                               // 0x0280(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
