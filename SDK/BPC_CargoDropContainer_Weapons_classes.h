...
// BlueprintGeneratedClass BPC_CargoDropContainer_Weapons.BPC_CargoDropContainer_Weapons_C
// 0x0060 (0x0480 - 0x0420)
class ABPC_CargoDropContainer_Weapons_C : public ABP_CargoDropContainer_Empty_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BPC_CargoDropContainer_Weapons.BPC_CargoDropContainer_Weapons_C");
		return ptr;
	}
