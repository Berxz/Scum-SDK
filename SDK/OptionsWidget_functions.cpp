...
void UOptionsWidget_C::BndEvt__ShowAdditionalInfoOnWidget_K2Node_ComponentBoundEvent_15_OnValueChanged__DelegateSignature(int Index, int OldIndex, const struct FText& Value)
{
