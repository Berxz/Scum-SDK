...
public:
	...
	struct FVector                                     TriggeredMovement_PromTrapTriggerCurve_E937A8874F7B8AC6150893BF78948185;// 0x09E8(0x000C) (IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    TriggeredMovement__Direction_E937A8874F7B8AC6150893BF78948185;// 0x09F4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x09F5(0x0003) MISSED OFFSET
	class UTimelineComponent*                          TriggeredMovement;                                        // 0x09F8(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
