...
// Function BP_WeaponBullet_BroadHead_CarbonArrow.BP_WeaponBullet_BroadHead_CarbonArrow_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)

void ABP_WeaponBullet_BroadHead_CarbonArrow_C::UserConstructionScript()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_WeaponBullet_BroadHead_CarbonArrow.BP_WeaponBullet_BroadHead_CarbonArrow_C.UserConstructionScript");

	ABP_WeaponBullet_BroadHead_CarbonArrow_C_UserConstructionScript_Params params;
...
void ABP_WeaponBullet_BroadHead_CarbonArrow_C::ReceiveBeginPlay()
{
...
void ABP_WeaponBullet_BroadHead_CarbonArrow_C::ExecuteUbergraph_BP_WeaponBullet_BroadHead_CarbonArrow(int EntryPoint)
{
