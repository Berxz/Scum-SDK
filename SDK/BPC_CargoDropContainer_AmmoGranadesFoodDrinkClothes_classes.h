...
// BlueprintGeneratedClass BPC_CargoDropContainer_AmmoGranadesFoodDrinkClothes.BPC_CargoDropContainer_AmmoGranadesFoodDrinkClothes_C
// 0x0060 (0x0480 - 0x0420)
class ABPC_CargoDropContainer_AmmoGranadesFoodDrinkClothes_C : public ABP_CargoDropContainer_Empty_C
{
public:
	...
	class UStaticMeshComponent*                        StaticMesh11;                                             // 0x0458(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UStaticMeshComponent*                        StaticMesh9;                                              // 0x0460(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UStaticMeshComponent*                        hrthr;                                                    // 0x0468(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BPC_CargoDropContainer_AmmoGranadesFoodDrinkClothes.BPC_CargoDropContainer_AmmoGranadesFoodDrinkClothes_C");
		return ptr;
	}
