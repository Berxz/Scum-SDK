...
public:
	...
	class UTextBlock*                                  TextBlockStatTextDown;                                    // 0x02D0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	class UTextBlock*                                  TextBlockTDValue;                                         // 0x02E8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	struct FLinearColor                                TextColor;                                                // 0x02F8(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FText                                       _bodyTemperature;                                         // 0x0308(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       _maxTemp;                                                 // 0x0320(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       _temperatureDeviation;                                    // 0x0338(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FLinearColor                                _alarmColor;                                              // 0x0350(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	float                                              _fBodyTemperature;                                        // 0x0360(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void SetTemperatureDeviationText(const struct FText& temperatureDeviationText);
	void SetTemperatureDeviation(float temperatureDeviation);
	void SetTemperatureExtremes(const struct FText& tempExtremes);
