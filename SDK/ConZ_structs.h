...
enum class EInteractionType : uint8_t
{
	...
	EInteractionType__OpenContainer = 146,
	EInteractionType__ChangeItemText = 147,
	EInteractionType__CommitItemText = 148,
	EInteractionType__TurnOn       = 149,
	EInteractionType__TurnOff      = 150,
	EInteractionType__AddProximityTrigger = 151,
	EInteractionType__AddLaserTrigger = 152,
	EInteractionType__AddTripwireTrigger = 153,
	EInteractionType__RemoveTrigger = 154,
	EInteractionType__ShowTrigger  = 155,
	EInteractionType__ArmTrap      = 156,
	EInteractionType__DisarmTrap   = 157,
	EInteractionType__BuryTrap     = 158,
	EInteractionType__UnburyTrap   = 159,
	EInteractionType__EInteractionType_MAX = 160
};
